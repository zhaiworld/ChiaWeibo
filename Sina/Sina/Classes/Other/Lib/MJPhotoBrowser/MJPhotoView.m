...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame])) {
        ...
        UIPinchGestureRecognizer *pinchGest = [[UIPinchGestureRecognizer alloc] initWithTarget:self action:@selector(handlePinch:)];
...
#pragma mark - zhaixirui
-(void)handlePinch:(UIPinchGestureRecognizer *)pinchGest
{
    CGFloat scale = pinchGest.scale;
    NSLog(@".....scale....%f",scale);
    CGFloat velocity = pinchGest.velocity;
    NSLog(@".....velocity....%f",velocity);
    switch (pinchGest.state) {
        case UIGestureRecognizerStateChanged:
            pinchGest.view.transform = CGAffineTransformScale(pinchGest.view.transform, scale, scale);
            pinchGest.scale = 1;
            break;
